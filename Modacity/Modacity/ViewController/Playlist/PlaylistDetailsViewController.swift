...
class PlaylistDetailsViewController: UIViewController {
    ...
    @IBAction func onBack(_ sender: Any) {
        AmplitudeTracker.LogStringEvent("Playlist Back Button", extraParamName: "duringSession", extraParamValue: self.isPlaying)
        if self.isPlaying {
    ...
    @IBAction func onStart(_ sender: Any) {
        ...
        if !self.isPlaying {
            AmplitudeTracker.LogStringEvent("Pressed Start Practice")
            ...
            AmplitudeTracker.LogStringEvent("Pressed Finish Practice", extraParamName: "Practice Time", extraParamValue: self.playlistPracticeTotalTimeInSec)
