...
class PlaylistFinishViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        AmplitudeTracker.LogStringEvent("Congratulations Screen", extraParamName: "total seconds", extraParamValue:self.playlistDetailsViewModel.sessionDurationInSecond)
    ...
    @IBAction func onBack(_ sender: Any) {
        AmplitudeTracker.LogStringEvent("Congrats Screen Back Button")
        self.navigationController?.popViewController(animated: true)
    }
    
    @IBAction func onRemindMe(_ sender: Any) {
        AmplitudeTracker.LogStringEvent("Congrats Screen Reminder Button")
    }
    
    @IBAction func onSkip(_ sender: Any) {
        self.navigationController?.dismiss(animated: true, completion: nil)
        AmplitudeTracker.LogStringEvent("Congrats Screen Skip Button")
    }
}
