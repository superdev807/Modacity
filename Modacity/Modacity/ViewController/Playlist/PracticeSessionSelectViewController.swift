//
//  PracticeSessionSelectViewController.swift
//  Modacity
//
...
protocol PracticeSessionSelectViewControllerDelected {
    func playlistViewController(_ controller: PlaylistListViewController, selectedPlaylist: Playlist)
}

class PracticeSessionSelectViewController: ModacityParentViewController {
