...
class MetrodronePlayer: DroneFrameDelegate {
    ...
    func changeDuration(newValue: Float) {
        ...
        AmplitudeTracker.LogStringEvent("Changed Metrodrone Duration", extraParamName: "duration", extraParamValue: newValue)
        goMetronome()
    }
    
    func toggleSustain() -> Bool {
        sustain = !sustain
        AmplitudeTracker.LogStringEvent("Toggled Sustain")
    ...
    func setSubdivision(_ divisions:Int) {
        AmplitudeTracker.LogStringEvent("Set subdivision", extraParamName: "subdivision", extraParamValue: divisions)
